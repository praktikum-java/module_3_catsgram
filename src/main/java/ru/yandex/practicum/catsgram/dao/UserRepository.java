...
//        String sql = "INSERT INTO users(username, email, password, registration_date, profile_photo_url, profile_description) " +
//                "VALUES (?, ?, ?, ?, ?, ?)";
...
//            statement.setString(5, user.getProfile().getPhotoUrl());
//            statement.setString(6, user.getProfile().getDescription());
    ...
    public User update(User user) {
        String sql = "UPDATE users SET username = ?, email = ?, password = ?, profile_photo_url = ?, profile_description = ? WHERE id = ?";
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            statement.setString(2, user.getEmail());
            statement.setString(3, user.getPassword());
            statement.setString(4, user.getProfile().getPhotoUrl());
            statement.setString(5, user.getProfile().getDescription());
    ...
    private User mapUser(ResultSet resultSet) throws SQLException {
        ...
        profile.setPhotoUrl(resultSet.getString("profile_photo_url"));
        profile.setDescription(resultSet.getString("profile_description"));
